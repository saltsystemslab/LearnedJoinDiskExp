...
flags.DEFINE_string("ratios", "1000", "")
flags.DEFINE_string("indexes", "alex","")
...
def main(argv):
    ...
    test_config = "--spec=./experiments/join/join_alex.jsonnet"
    ...
    for thread in threads:
        for dataset in datasets:
            ...
            args.append(f'--use_alex')
            if FLAGS.only_input:
                args.append('--only_input')
