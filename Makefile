...
LEARNED_MERGE=-DLEARNED_MERGE=1 -DTRACK_STATS=0 -DTRACK_PLR_TRAIN_TIME=1 -DTRUST_ERROR_BOUNDS=1 -DASSERT_SORT=0 -DPLR_POS_OFFSET=5 -DPLR_ERROR_BOUND=${ERROR_BOUND} -DPGM_ERROR_BOUND=1 -DUSE_STRING_KEYS=0 -DUSE_INT_128=0 -DUSE_BULK_COPY=1 -DMAX_KEYS_TO_BULK_COPY=100
