...
LEARNED_MERGE=-DLEARNED_MERGE=1 -DTRACK_STATS=0 -DTRACK_PLR_TRAIN_TIME=0 -DTRUST_ERROR_BOUNDS=0 -DASSERT_SORT=1 -DPLR_POS_OFFSET=5 -DPLR_ERROR_BOUND=5 -DPGM_ERROR_BOUND=1 -DUSE_STRING_KEYS=1 -DUSE_INT_128=0 -DUSE_BULK_COPY=1 -DMAX_KEYS_TO_BULK_COPY=100
