...
LEARNED_MERGE=-DLEARNED_MERGE=1 -DTRACK_STATS=1 -DTRACK_PLR_TRAIN_TIME=1 -DTRUST_ERROR_BOUNDS=0 -DASSERT_SORT=0 -DPLR_POS_OFFSET=5 -DPLR_ERROR_BOUND=$(ERROR_BOUND) -DPGM_ERROR_BOUND=1 -DUSE_STRING_KEYS=${USE_STRING_KEYS} -DUSE_INT_128=${USE_INT_128} -DUSE_BULK_COPY=${USE_BULK_COPY} -DMAX_KEYS_TO_BULK_COPY=1000000 -DTRAIN_RESULT=${TRAIN_RESULT}
